...
def train_model(X_train, y_train, model, criterion, optimizer, scheduler, num_epochs=20000):
    train_losses = []
...
if __name__ == "__main__":
    data = pd.read_excel('traindata_ase_new.xlsx', engine='openpyxl')
    ...
    torch.save(model.state_dict(), 'model_AQ.pth')
